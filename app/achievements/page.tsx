    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">发现优秀科技成果，探索创新应用场景</p>
          </div>
      ...
      <div className="bg-white rounded-custom shadow-md p-6 mb-8">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-title">成果筛选</h2>
          <div className="flex items-center space-x-3">
            <span className="text-sm text-gray-500">有好的成果想分享？</span>
            <button className="bg-accent-100 text-accent-700 px-4 py-2 rounded-custom hover:bg-accent-200 transition-colors flex items-center space-x-1 text-sm">
              <span>➕</span>
              <span>发布成果</span>
            </button>
          </div>
